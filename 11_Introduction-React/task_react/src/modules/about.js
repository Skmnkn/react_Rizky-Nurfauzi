...
import downLogo from "../assets/img/logo-ALTA-v2.png";
import facebook from "../assets/img/ic_fb.png";
import twitter from "../assets/img/ic-instagram.png";
import instagram from "../assets/img/ic-twitter.png";
import linkedin from "../assets/img/ic-linkedin.png";
        ...
        <div className="container">
          <div className="row pt-5 pb-5">
            <div className="pl-5 col-lg-5 col-md-4 col-sm-12 col-12 text-lg-left text-md-left text-sm-center">
              <a href="index.html">
                <img className="logo-bawah" src={downLogo} />
              </a>
            </div>
